...
class ModeloReportesProyecto{
    ...
    public function resultadoBuscadorFacturasIngreso($consulta,$cond=''){
        
        $this->db->query('SELECT fac.*, apro.idProyecto, apre.idACCION, afo.NOMBREACCION, 
                        ...
                        gru.nombreG AS nombreGrupo
                        FROM facturascabecera fac
                        LEFT JOIN acciones_proyecto apro ON apro.idAccionProy=fac.idaccionproy
                        ...
                        LEFT JOIN colaboradoresN col ON fac.idempresa=col.idEMPRESA
                        ...
                        LEFT JOIN agentesclientes agcli ON fac.idempresa=agcli.idEmpresa

...
<html lang="es">
    ...
    <body>
        <div class="factura">
            ...
            <span><img src="<?php echo RUTA_URL; ?>/img/logoFundae.jpg" width="100" style="float: right;"></span>
        </div>
        <div style="text-align: center;"><h3>CONTROL DE ASISTENCIA</h3></div>
        ...
        <div class="factura">
            ...
            <p style="color: #0618ef;">
                <span>SESIÓN Nº: <?php echo $datos['cabecera']->accionformativa; ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span>FECHA: <?php echo $datos['cabecera']->idProyecto; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            
            </p>
            <p style="color: #0618ef;">           
                <span>FECHA: <?php echo $datos['cabecera']->idProyecto; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span>HORARIO DE: ___:___ <?php echo ($datos['cabecera']->X); ?></span>&nbsp;&nbsp;
                <span>A: ___:___ <?php echo ($datos['cabecera']->X); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span>Y  HORARIO DE: ___:___ <?php echo ($datos['cabecera']->X); ?></span>&nbsp;&nbsp;
                <span>A: ___:___ <?php echo ($datos['cabecera']->X); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </p>
        </div>

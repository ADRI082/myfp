$(document).ready(function() {
    ...
    $('#actEmpresariales').on( 'error.dt', function ( e, settings, techNote, message ) {
        console.log( 'An error has been reported by DataTables: ', message );
    } ) .DataTable();
    $('#actEmpresariales').DataTable();

...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Actividades Empresariales</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Actividades Empresariales</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="table-responsive">
                <table id="actEmpresariales" class="table table-striped table-bordered" style="width:100%">
                  <thead style="background-color:#001f3f; color:#fff;">
                        <tr>
                            ...
                            <th style="font-size:0.8em !important;">Referencia web</th>
                            <th style="font-size:0.8em !important;">Acciones</th>
                        </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($datos['actEmpresariales'] as $actividad) : ?>
                        <tr>
                            <td style="font-size:0.9em !important;"><?php echo $actividad->CODCNAE; ?></td>
                            <td style="font-size:0.9em !important;"><?php echo $actividad->DESACTIVIDAD; ?></td>
                            <td style="font-size:0.9em !important;"><?php echo $actividad->ENLACEWEB; ?></td>
                            <td style="font-size:0.9em !important;">
                <?php                                
                      echo "
                        <div class='row'>
                          <div class='text-center'>
                            <a class='btn btn-info btn-sm updateActEmpresariales' data-id=".$actividad->IDACTIVIDAD." href='' title='Editar Actividad'><i class='fas fa-pencil-alt'></i></a>
                          </div>
                          <div class='text-center'>
                            <a class='btn btn-danger btn-sm deleteActividad' data-id=".$actividad->IDACTIVIDAD." href='' title='Eliminar Actividad'><i class='fa fa-trash' class='text-white'></i></a>
                          </div>
                        </div>";
                ?> 
                    <?php endforeach; ?>

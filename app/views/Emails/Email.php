      ...
      <div><h2 style='color:orange'>Se ha creado una nueva tarea en la agenda:</h2><strong style=' margin-left:5px'>  INICIO: </strong style=' margin-left:5px'>" . date("d-m-Y H:i:s",strtotime($datos['inicio'])). "<br><br><strong style=' margin-left:5px'>FIN:</strong> ".date("d-m-Y H:i:s",strtotime($datos['fin'])). 
      "<br><br><strong style='margin-left:5px;margin-bottom:10px'>TAREA:  </strong>" .$datos['actividad']."
      </div>
      ...
      try {
          ...
          //  $mail->SMTPDebug = 1; // debugging: 1 = errors and messages, 2 = messages only
            ...
            $mail->Body = $mensaje ;           
            // $mail->AddAddress($datosAgente->mail);

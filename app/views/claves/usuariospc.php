...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Claves Usuarios PC</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Claves Usuarios PC</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container">
      <div class="box">
      <div><a href="<?php echo RUTA_URL; ?>/claves/agregarUsuariosPc"><i class="fas fa-plus-square" style="font-size:28px;color:blue;"></i></a></div>
...
<table id="claves_pc" class="table table-striped table-bordered" style="width:100%">
        ...
        <?php foreach ($datos['registros'] as $acciones) : ?>
            ...
            <tr>
                ...
                <td class="project-actions text-right">
                    ...
                    <a class="btn btn-info btn-sm" href="<?php echo RUTA_URL; ?>/claves/editarUsuariosPc/<?php echo $acciones->idClave; ?>">
                      <i class="fas fa-pencil-alt">
                      </i>
                    </a>
                    <a class="btn btn-danger btn-sm" href="<?php echo RUTA_URL; ?>/claves/borrarUsuariosPc/<?php echo $acciones->idClave; ?>">

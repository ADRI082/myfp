         ...
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             <?php
                ...
                if ($_SESSION['rol'] == '1' || $_SESSION['rol'] == '3') {
                    $permisos = [
                        ...
                        'Tipos Gastos Generales', 'Materiales', 'Modalidades', 'Plantillas', 'Roles', 'Sectores', 'Tipos de Acción', 'Vídeos', 'Mi perfil','Cursos','Mis Asignaturas','Historial'
                    ];
                } else {
             ...
             <li class="nav-item has-treeview">
                 ...
                 <ul class="nav nav-treeview">
                     <?php
                        $videos = array(
                            array('nombre' => 'Historial', 'url' => 'Historial', 'icon' => 'far fa-clock')
